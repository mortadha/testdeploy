...
export class Dashboard1Component {
    ...
    ffloks  : number;
    users   : number;
    constructor(private placeService: PlaceService,private fflockService : FflokService ,private userService : UserService) { }

    ngOnInit() {
       this.placeService.countPlaces().subscribe((data : any)=>{
           this.places = data.result.places;
       });

       this.fflockService.countfflok().subscribe((data : any)=>{
          this.ffloks = data.result.ffloks;
        });

        this.userService.countUser().subscribe((data : any)=>{
